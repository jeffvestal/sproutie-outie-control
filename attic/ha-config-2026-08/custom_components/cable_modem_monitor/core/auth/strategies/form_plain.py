...
<redacted>
    ...
    def _build_combined_form_data(
        ...
        log("Combined credential auth: <redacted>
        return {config.credential_field: <redacted>
...
<redacted>
        ...
        return {config.username_field: <redacted>

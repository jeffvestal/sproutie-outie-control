        ...
        return vol.Schema(
            {
                ...
                vol.Optional(CONF_USERNAME, default=default_username): <redacted>
                vol.Optional(CONF_PASSWORD, default=default_password): <redacted>
...
class OptionsFlowHandler(ConfigFlowMixin, config_entries.OptionsFlow):
        ...
        return vol.Schema(
            {
                vol.Required(CONF_HOST, default=default_host): str,
                vol.Optional(CONF_USERNAME, default=default_username): <redacted>
                vol.Optional(CONF_PASSWORD, default=""): <redacted>
                vol.Required(CONF_MODEM_CHOICE, default=default_modem): selector.SelectSelector(
                    selector.SelectSelectorConfig(
                        options=self._modem_choices,
                        mode=selector.SelectSelectorMode.DROPDOWN,
    ...
    def _preserve_credentials(self, user_input: <redacted>
